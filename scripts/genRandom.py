...
#        elif gatetype == 2: # SDG
#            qubit = rd.randint(0, nQubits-1)
#            fout.write('sdg q[' + str(qubit) +'];\n')
        elif gatetype == 2: # T
            qubit = rd.randint(0, nQubits-1)
            fout.write('t q[' + str(qubit) +'];\n')
#        elif gatetype == 4: # TDG
#            qubit = rd.randint(0, nQubits-1)
#            fout.write('tdg q[' + str(qubit) +'];\n')
#        elif gatetype == 5: # Rx
#            qubit = rd.randint(0, nQubits-1)
...
#                qubit3 = rd.randint(0, nQubits-1)
#            fout.write('cswap q[' + str(qubit1) +'], q[' + str(qubit2) +'], q[' + str(qubit3)+'];\n')
